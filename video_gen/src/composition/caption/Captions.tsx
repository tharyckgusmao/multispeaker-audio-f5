...
import { getSentenceToDisplay } from "../font/sentence-to-display";
import {
  filterCurrentlyDisplayedLines,
  filtersIfStartedDisplayedLines,
  layoutText,
} from "../font/get-number-of-lines-for-text";
...
export const PaginatedCaptions: React.FC<{
  ...
  const showIfStartedLines = filtersIfStartedDisplayedLines({
    lines:currentlyShownLines,
    frame,
  });
